 ...
 */
func calculateHeartRateAverage(_ values: Int...) -> Int {
    return values.reduce(0, +)/values.count
}

if let heartRate = heartRate {
    print(calculateHeartRateAverage(oldHR1, oldHR2, oldHR3, oldHR4, heartRate))
} else {
    print(calculateHeartRateAverage(oldHR1, oldHR2, oldHR3, oldHR4))
}
